...
/**
 * This class stands for GetStockListResponse StructType
 * @subpackage Structs
 */
class GetStockListResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetStockListResponse
     * @uses GetStockListResponse::setEmerystocklistresponse()
     ...
     * @param \RialtoWebService\StructType\StockListResponse $emerystocklistresponse
     * @return \RialtoWebService\StructType\GetStockListResponse
     */
