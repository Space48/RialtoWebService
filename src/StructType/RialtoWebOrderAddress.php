...
/**
 * This class stands for RialtoWebOrderAddress StructType
 * @subpackage Structs
 */
class RialtoWebOrderAddress extends AbstractStructBase
{
    /**
     * The Title
     * @var string
    ...
    public $Company;
    /**
     * Constructor method for RialtoWebOrderAddress
     * @uses RialtoWebOrderAddress::setTitle()
     * @uses RialtoWebOrderAddress::setFirstName()
     * @uses RialtoWebOrderAddress::setSurname()
     * @uses RialtoWebOrderAddress::setAd1()
     * @uses RialtoWebOrderAddress::setAd2()
     * @uses RialtoWebOrderAddress::setAd3()
     * @uses RialtoWebOrderAddress::setAd4()
     * @uses RialtoWebOrderAddress::setPcode()
     * @uses RialtoWebOrderAddress::setCountry()
     * @uses RialtoWebOrderAddress::setCompany()
     * @param string $title
     ...
     */
    public function __construct($title = null, $firstName = null, $surname = null, $ad1 = null, $ad2 = null, $ad3 = null, $ad4 = null, $pcode = null, $country = null, $company = null)
    {
        $this
            ->setTitle($title)
