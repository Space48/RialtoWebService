...
/**
 * This class stands for RialtoOrdersResponseError StructType
 * @subpackage Structs
 */
class RialtoOrdersResponseError extends AbstractStructBase
{
    /**
     * The OrderNo
     * @var string
    ...
    public $ErrorMessage;
    /**
     * Constructor method for RialtoOrdersResponseError
     * @uses RialtoOrdersResponseError::setOrderNo()
     * @uses RialtoOrdersResponseError::setErrorCode()
     * @uses RialtoOrdersResponseError::setErrorMessage()
     ...
     * Set OrderNo value
     * @param string $orderNo
     * @return \RialtoWebService\StructType\RialtoOrdersResponseError
     */
