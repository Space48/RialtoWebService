...
/**
 * This class stands for GetUpdatedOrdersResponse StructType
 * @subpackage Structs
 */
class GetUpdatedOrdersResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetUpdatedOrdersResponse
     * @uses GetUpdatedOrdersResponse::setEmeryorderdetailsresponse()
     ...
     * @param \RialtoWebService\StructType\OrderDetailsResponse $emeryorderdetailsresponse
     * @return \RialtoWebService\StructType\GetUpdatedOrdersResponse
     */
