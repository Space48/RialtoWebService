...
/**
 * This class stands for AddRialtoOrdersStr StructType
 * @subpackage Structs
 */
class AddRialtoOrdersStr extends AbstractStructBase
{
    /**
     * The ordersXML
    ...
    public $Password;
    /**
     * Constructor method for AddRialtoOrdersStr
     * @uses AddRialtoOrdersStr::setOrdersXML()
     * @uses AddRialtoOrdersStr::setUserName()
     * @uses AddRialtoOrdersStr::setPassword()
     ...
     * Set ordersXML value
     * @param string $ordersXML
     * @return \RialtoWebService\StructType\AddRialtoOrdersStr
     */
