...
/**
 * This class stands for RialtoOrderDetail StructType
 * @subpackage Structs
 */
class RialtoOrderDetail extends AbstractStructBase
{
    /**
     * The OrderNo
     * @var string
    ...
    public $OrderNo;
    /**
     * Constructor method for RialtoOrderDetail
     * @uses RialtoOrderDetail::setOrderNo()
     ...
     * Set OrderNo value
     * @param string $orderNo
     * @return \RialtoWebService\StructType\RialtoOrderDetail
     */
