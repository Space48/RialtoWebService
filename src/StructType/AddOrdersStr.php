...
/**
 * This class stands for AddOrdersStr StructType
 * @subpackage Structs
 */
class AddOrdersStr extends AbstractStructBase
{
    /**
     * The ordersXML
    ...
    public $Password;
    /**
     * Constructor method for AddOrdersStr
     * @uses AddOrdersStr::setOrdersXML()
     * @uses AddOrdersStr::setUserName()
     * @uses AddOrdersStr::setPassword()
     ...
     * Set ordersXML value
     * @param string $ordersXML
     * @return \RialtoWebService\StructType\AddOrdersStr
     */
