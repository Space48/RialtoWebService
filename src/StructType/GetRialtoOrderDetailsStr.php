...
/**
 * This class stands for GetRialtoOrderDetailsStr StructType
 * @subpackage Structs
 */
class GetRialtoOrderDetailsStr extends AbstractStructBase
{
    /**
     * The ordersXML
    ...
    public $Password;
    /**
     * Constructor method for GetRialtoOrderDetailsStr
     * @uses GetRialtoOrderDetailsStr::setOrdersXML()
     * @uses GetRialtoOrderDetailsStr::setUserName()
     * @uses GetRialtoOrderDetailsStr::setPassword()
     ...
     * Set ordersXML value
     * @param string $ordersXML
     * @return \RialtoWebService\StructType\GetRialtoOrderDetailsStr
     */
