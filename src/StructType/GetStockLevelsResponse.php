...
/**
 * This class stands for GetStockLevelsResponse StructType
 * @subpackage Structs
 */
class GetStockLevelsResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetStockLevelsResponse
     * @uses GetStockLevelsResponse::setRialtostocklevelresponse()
     ...
     * @param \RialtoWebService\StructType\StockLevelsResponse $rialtostocklevelresponse
     * @return \RialtoWebService\StructType\GetStockLevelsResponse
     */
